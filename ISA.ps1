...
<#
	.SYNOPSIS
		Author: Caabv
		Based on: Jakub Palaczynski - Privesc
	...
	.PARAMETER Mode
		Mode to use - full or quick (default).
...
#>
	...
	# Check to see if extended "scan" has to be done
	if ($extended) { 
		$long = 'yes' 
	} 
	else { $long = 'no' 
    ...
    if ($mode -eq 'quick') {
		...
		Write "---------------------------------------------------------------------"
        $i = 0
        if (Test-Path $env:SystemDrive\sysprep.inf) { 
			Write "$env:SystemDrive\sysprep.inf" ; $i = 1
		}
        if (Test-Path $env:SystemDrive\sysprep\sysprep.xml) { 
			Write "$env:SystemDrive\sysprep\sysprep.xml" ; $i = 1 
		}
        if (Test-Path $env:WINDIR\Panther\Unattend\Unattended.xml) { 
			Write "$env:WINDIR\Panther\Unattend\Unattended.xml" ; $i = 1 
		}
        if (Test-Path $env:WINDIR\Panther\Unattended.xml) { 
			Write "$env:WINDIR\Panther\Unattended.xml" ; $i = 1 
		}
    	if (Test-Path $env:WINDIR\system32\sysprep\Unattend.xml) {
			Write "$env:WINDIR\system32\sysprep\Unattend.xml" ; $i = 1 
		}
    	if (Test-Path $env:WINDIR\system32\sysprep\Panther\Unattend.xml) { 
			Write "$env:WINDIR\system32\sysprep\Panther\Unattend.xml" ; $i = 1 
		}
    	if (Test-Path $env:WINDIR\Panther\Unattend\Unattended.xml) { 
			Write "$env:WINDIR\Panther\Unattend\Unattended.xml" ; $i = 1 
		}
    	if (Test-Path $env:WINDIR\Panther\Unattend.xml) { 
			Write "$env:WINDIR\Panther\Unattend.xml" ; $i = 1 
		}
    	if (Test-Path $env:SystemDrive\MININT\SMSOSD\OSDLOGS\VARIABLES.DAT) { 
			Write "$env:SystemDrive\MININT\SMSOSD\OSDLOGS\VARIABLES.DAT" ; $i = 1 
		}
    	if (Test-Path $env:WINDIR\panther\setupinfo) { 
			Write "$env:WINDIR\panther\setupinfo" ; $i = 1 
		}
    	if (Test-Path $env:WINDIR\panther\setupinfo.bak) { 
			Write "$env:WINDIR\panther\setupinfo.bak" ; $i = 1 
		}
        if (Test-Path $env:SystemDrive\unattend.xml) { 
			Write "$env:SystemDrive\unattend.xml" ; $i = 1 
		}
        if (Test-Path $env:WINDIR\system32\sysprep.inf) { 
			Write "$env:WINDIR\system32\sysprep.inf" ; $i = 1 
		}
        if (Test-Path $env:WINDIR\system32\sysprep\sysprep.xml) { 
			Write "$env:WINDIR\system32\sysprep\sysprep.xml" ; $i = 1 
		}
        if (Test-Path $env:WINDIR\Microsoft.NET\Framework64\v4.0.30319\Config\web.config) { 
			Write "$env:WINDIR\Microsoft.NET\Framework64\v4.0.30319\Config\web.config" ; $i = 1 
		}
        if (Test-Path $env:SystemDrive\inetpub\wwwroot\web.config) { 
			Write "$env:SystemDrive\inetpub\wwwroot\web.config" ; $i = 1 
		}
        if (Test-Path "$env:AllUsersProfile\Application Data\McAfee\Common Framework\SiteList.xml") { 
			Write "$env:AllUsersProfile\Application Data\McAfee\Common Framework\SiteList.xml" ; $i = 1 
		}
        if (Test-Path HKLM:\SOFTWARE\RealVNC\WinVNC4) { 
			Get-ChildItem -Path HKLM:\SOFTWARE\RealVNC\WinVNC4 ; $i = 1 
		}
        if (Test-Path HKCU:\Software\SimonTatham\PuTTY\Sessions) { 
			Get-ChildItem -Path HKCU:\Software\SimonTatham\PuTTY\Sessions ; $i = 1 
		}
        if ($i -eq 0) { 
...
Write "---------------------------------------------------------------------"
        ...
        if (Test-Path HKLM:\SOFTWARE\Policies\Microsoft\Windows\Installer) { 
			Get-ItemProperty -Path HKLM:\SOFTWARE\Policies\Microsoft\Windows\Installer -Name AlwaysInstallElevated ; $i = 1 
		}
        if (Test-Path HKCU:\SOFTWARE\Policies\Microsoft\Windows\Installer) { 
			Get-ItemProperty -Path HKCU:\SOFTWARE\Policies\Microsoft\Windows\Installer -Name AlwaysInstallElevated ; $i = 1 
		}
        if ($i -eq 0) { 
			Write "Registries not found."
		}
		...
		Write "User privileges do not allow for rotten potato exploit." 
		}    
        ...
        if (Test-Path HKLM:\Software\Policies\Microsoft\Windows\WindowsUpdate) { 
			(Get-ItemProperty -Path HKLM:\Software\Policies\Microsoft\Windows\WindowsUpdate -Name WUServer).WUServer ; $i = 1 
		}
        if ($i -eq 0) { 
			Write "WSUS misconfiguration not found."
		}
        ...
        #Replace with Get-UnquotedPath from ISA
        ...
        if ($result -ne $null) { 
			...
			Write "Weak services were not found." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set for all PATH variable entries are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on System32 directory are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on System32 files and directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on Windows Temp directory are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on Program Files directory are correct for all groups." 
		}
        ...
        if ($result -ne $null) {
			...
			Write "Permissions set on Program Files files and directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on All Users startup files and directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on startup executables are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on startup executables directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on uninstall registry keys and subkeys are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on services are correct for all groups. Double check - each part of SDDL should have A as Allow at the beginning." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on services registry keys and subkeys are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on service binaries are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on service directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on process binaries are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on process directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on scheduled binaries are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on scheduled binary directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on loaded DLLs are correct for all groups." 
		}
    ...
    ElseIf ($mode -eq 'full') {
        ...
        if ($result -like "*$whoami*") { 
			Write $result 
		} 
		else { 
			Write "User is probably from another domain than this server." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on ProgrmData files and directories are correct for all groups." 
		}
    ...
    If ($long -eq 'yes') {
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions on all files and directories are correct for all groups." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "There were no potentially sensitive registry keys found." 
		}
        ...
        if ($result -ne $null) { 
			...
			Write "Permissions set on HKLM registry keys are correct for all groups." 
		}
